...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:campus_events_connector/Resources/Private/Language/locallang_db.xlf:tx_campuseventsconnector_domain_model_category',
        'label' => 'name',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'versioningWS' => true,
...
//            'endtime' => 'endtime',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                'type' => 'group',
                'allowed' => 'tx_campuseventsconnector_domain_model_category',
                'size' => 1,
                'maxitems' => 1,
                'minitems' => 0,
                'default' => 0,
